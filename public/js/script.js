...
function validateForm() {
    // Get form inputs
    const title = document.getElementById('note-has-title').value.trim();
    const category = document.getElementById('note-has-category').value.trim();
    const description = document.getElementById('note-has-description').value.trim();
    ...
    document.getElementById('description-warning').textContent = '';

    // Validate title, category, and description
    if (title === '') {
        document.getElementById('title-warning').textContent = 'Title is required';
        return false;
    }

    if (category === '') {
        document.getElementById('category-warning').textContent = 'Category is required';
        return false;
    }

    if (description === '') {
        document.getElementById('description-warning').textContent = 'Description is required';
        return false;
    }
